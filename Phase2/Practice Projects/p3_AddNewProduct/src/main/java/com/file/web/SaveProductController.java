...
//		 Alert the user, if the Product ID entered was a letters instead of positive numbers.
		...
		try {
			// Create a dispatcher and get the Product id,Product name, Product company from
			// user (index.js)
			...
			// Inside Product DAO Create Product object and save the data from the user in
			// it
			...
			// Alert the user, if the Product ID entered was a letters instead of positive
			// numbers.
