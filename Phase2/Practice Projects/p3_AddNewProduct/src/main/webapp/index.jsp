...
<body>
	...
	<div style="width: 40%; height: 30%; margin: 20px;">
		<form class="form-inline" action="getProduct">
			...
			<button type="submit" class="btn btn-warning mb-2">Find</button>
		</form>
		...
		<form class="form-inline" action="saveProduct">
			...
			<div class="form-group mx-sm-3 mb-2">
				<label class="sr-only">Product ID</label> <input type="number"
					id="replyNumber" name="sid" min="0" data-bind="value:replyNumber"
			...
			<br/><br/>
			<div class="form-group mx-sm-3 mb-2">
				<label class="sr-only">Product Price</label> <input type="text"
					class="form-control" name="scompany" placeholder="Product Price">
			</div>
			<br/><br/>
